...
def render_item(
    ...
    # Only intercept rendering of *types*
    if type_ == "type" and isinstance(obj, postgresql.JSONB):
        # Avoid Alembic emitting JSONB(astext_type=Text())
...
def process_revision_directives(context, revision, directives) -> None:
    ...
    # If the generated code references postgresql.<Type>, ensure import exists.
    # script.imports is a set of import strings Alembic will render at top.
    # Adding redundantly is fine (it de-dupes).
