...
def upgrade() -> None:
    ...
    sa.Column('season_type', sa.Enum('PRE', 'REG', 'POST', 'OTHER', name='seasontypeenum'), nullable=True),
    ...
    sa.Column('stats_json', sa.JSON().with_variant(postgresql.JSONB(), 'postgresql'), nullable=False),
    ...
    op.create_index('ix_team_game_stats_team_game', 'team_game_stats', ['team_id', 'game_id'], unique=False)
